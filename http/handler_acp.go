...
func (s *acpHandler) AddActorRelationshipWithAAC(rw http.ResponseWriter, req *http.Request) {
	db := mustGetContextClientDB(req)

	var message addActorRelationshipWithAACRequest
	err := requestJSON(req, &message)
	if err != nil {
		responseJSON(rw, http.StatusBadRequest, errorResponse{err})
		return
	...
	addActorRelationshipResult, err := db.AddActorRelationshipWithAAC(
		req.Context(),
		message.Relation,
		message.TargetActor,
	)
...
func (s *acpHandler) DeleteActorRelationshipWithAAC(rw http.ResponseWriter, req *http.Request) {
	db := mustGetContextClientDB(req)

	var message deleteActorRelationshipWithAACRequest
	err := requestJSON(req, &message)
	if err != nil {
		responseJSON(rw, http.StatusBadRequest, errorResponse{err})
		return
	...
	deleteActorRelationshipResult, err := db.DeleteActorRelationshipWithAAC(
		req.Context(),
		message.Relation,
		message.TargetActor,
	)
...
func (s *acpHandler) ReEnableAdminACP(rw http.ResponseWriter, req *http.Request) {
	db := mustGetContextClientDB(req)

	err := db.ReEnableAdminACP(req.Context())
	if err != nil {
		responseJSON(rw, http.StatusBadRequest, errorResponse{err})
		return
	}
...
func (s *acpHandler) DisableAdminACP(rw http.ResponseWriter, req *http.Request) {
	db := mustGetContextClientDB(req)

	err := db.DisableAdminACP(req.Context())
	if err != nil {
		responseJSON(rw, http.StatusBadRequest, errorResponse{err})
		return
	}
...
func (s *acpHandler) AdminACPStatus(rw http.ResponseWriter, req *http.Request) {
	db := mustGetContextClientDB(req)

	statusAACResult, err := db.AdminACPStatus(req.Context())
	if err != nil {
		responseJSON(rw, http.StatusBadRequest, errorResponse{err})
		return
	}
...
func (h *acpHandler) bindRoutes(router *Router) {
	...
	router.AddRoute(
		...
		h.AddActorRelationshipWithAAC,
	)
	router.AddRoute(
		"/acp/aac/relationship",
		http.MethodDelete,
		deleteActorRelationshipAAC,
		h.DeleteActorRelationshipWithAAC,
	)
	router.AddRoute(
		"/acp/aac/re-enable",
		http.MethodPost,
