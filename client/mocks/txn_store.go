...
func (_mock *TxnStore) GetNACStatus(ctx context.Context) (client.StatusNACResult, error) {
	ret := _mock.Called(ctx)
	...
	var r0 client.StatusNACResult
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context) (client.StatusNACResult, error)); ok {
		return returnFunc(ctx)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context) client.StatusNACResult); ok {
		r0 = returnFunc(ctx)
	} else {
		r0 = ret.Get(0).(client.StatusNACResult)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context) error); ok {
		r1 = returnFunc(ctx)
	} else {
...
func (_c *TxnStore_GetNACStatus_Call) Return(statusNACResult client.StatusNACResult, err error) *TxnStore_GetNACStatus_Call {
	_c.Call.Return(statusNACResult, err)
	return _c
}

func (_c *TxnStore_GetNACStatus_Call) RunAndReturn(run func(ctx context.Context) (client.StatusNACResult, error)) *TxnStore_GetNACStatus_Call {
	_c.Call.Return(run)
	return _c
}
