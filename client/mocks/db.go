...
// AddActorRelationshipWithDAC provides a mock function for the type DB
func (_mock *DB) AddActorRelationshipWithDAC(ctx context.Context, collectionName string, docID string, relation string, targetActor string) (client.AddActorRelationshipResult, error) {
	ret := _mock.Called(ctx, collectionName, docID, relation, targetActor)

	if len(ret) == 0 {
		panic("no return value specified for AddActorRelationshipWithDAC")
	}
...
// DB_AddActorRelationshipWithDAC_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AddActorRelationshipWithDAC'
type DB_AddActorRelationshipWithDAC_Call struct {
	*mock.Call
}

// AddActorRelationshipWithDAC is a helper method to define mock.On call
//   - ctx
//   - collectionName
//   - docID
//   - relation
//   - targetActor
func (_e *DB_Expecter) AddActorRelationshipWithDAC(ctx interface{}, collectionName interface{}, docID interface{}, relation interface{}, targetActor interface{}) *DB_AddActorRelationshipWithDAC_Call {
	return &DB_AddActorRelationshipWithDAC_Call{Call: _e.mock.On("AddActorRelationshipWithDAC", ctx, collectionName, docID, relation, targetActor)}
}

func (_c *DB_AddActorRelationshipWithDAC_Call) Run(run func(ctx context.Context, collectionName string, docID string, relation string, targetActor string)) *DB_AddActorRelationshipWithDAC_Call {
...
func (_c *DB_AddActorRelationshipWithDAC_Call) Return(addActorRelationshipResult client.AddActorRelationshipResult, err error) *DB_AddActorRelationshipWithDAC_Call {
	_c.Call.Return(addActorRelationshipResult, err)
	return _c
}

func (_c *DB_AddActorRelationshipWithDAC_Call) RunAndReturn(run func(ctx context.Context, collectionName string, docID string, relation string, targetActor string) (client.AddActorRelationshipResult, error)) *DB_AddActorRelationshipWithDAC_Call {
	_c.Call.Return(run)
	return _c
}
...
// AddPolicyWithDAC provides a mock function for the type DB
func (_mock *DB) AddPolicyWithDAC(ctx context.Context, policy string) (client.AddPolicyResult, error) {
	ret := _mock.Called(ctx, policy)

	if len(ret) == 0 {
		panic("no return value specified for AddPolicyWithDAC")
	}
...
// DB_AddPolicyWithDAC_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AddPolicyWithDAC'
type DB_AddPolicyWithDAC_Call struct {
	*mock.Call
}

// AddPolicyWithDAC is a helper method to define mock.On call
//   - ctx
//   - policy
func (_e *DB_Expecter) AddPolicyWithDAC(ctx interface{}, policy interface{}) *DB_AddPolicyWithDAC_Call {
	return &DB_AddPolicyWithDAC_Call{Call: _e.mock.On("AddPolicyWithDAC", ctx, policy)}
}

func (_c *DB_AddPolicyWithDAC_Call) Run(run func(ctx context.Context, policy string)) *DB_AddPolicyWithDAC_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *DB_AddPolicyWithDAC_Call) Return(addPolicyResult client.AddPolicyResult, err error) *DB_AddPolicyWithDAC_Call {
	_c.Call.Return(addPolicyResult, err)
	return _c
}

func (_c *DB_AddPolicyWithDAC_Call) RunAndReturn(run func(ctx context.Context, policy string) (client.AddPolicyResult, error)) *DB_AddPolicyWithDAC_Call {
	_c.Call.Return(run)
	return _c
}
...
// DeleteActorRelationshipWithDAC provides a mock function for the type DB
func (_mock *DB) DeleteActorRelationshipWithDAC(ctx context.Context, collectionName string, docID string, relation string, targetActor string) (client.DeleteActorRelationshipResult, error) {
	ret := _mock.Called(ctx, collectionName, docID, relation, targetActor)

	if len(ret) == 0 {
		panic("no return value specified for DeleteActorRelationshipWithDAC")
	}
...
// DB_DeleteActorRelationshipWithDAC_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteActorRelationshipWithDAC'
type DB_DeleteActorRelationshipWithDAC_Call struct {
	*mock.Call
}

// DeleteActorRelationshipWithDAC is a helper method to define mock.On call
//   - ctx
//   - collectionName
//   - docID
//   - relation
//   - targetActor
func (_e *DB_Expecter) DeleteActorRelationshipWithDAC(ctx interface{}, collectionName interface{}, docID interface{}, relation interface{}, targetActor interface{}) *DB_DeleteActorRelationshipWithDAC_Call {
	return &DB_DeleteActorRelationshipWithDAC_Call{Call: _e.mock.On("DeleteActorRelationshipWithDAC", ctx, collectionName, docID, relation, targetActor)}
}

func (_c *DB_DeleteActorRelationshipWithDAC_Call) Run(run func(ctx context.Context, collectionName string, docID string, relation string, targetActor string)) *DB_DeleteActorRelationshipWithDAC_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(string), args[4].(string))
	})
	return _c
...
func (_c *DB_DeleteActorRelationshipWithDAC_Call) Return(deleteActorRelationshipResult client.DeleteActorRelationshipResult, err error) *DB_DeleteActorRelationshipWithDAC_Call {
	_c.Call.Return(deleteActorRelationshipResult, err)
	return _c
}

func (_c *DB_DeleteActorRelationshipWithDAC_Call) RunAndReturn(run func(ctx context.Context, collectionName string, docID string, relation string, targetActor string) (client.DeleteActorRelationshipResult, error)) *DB_DeleteActorRelationshipWithDAC_Call {
	_c.Call.Return(run)
	return _c
}
