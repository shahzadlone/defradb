...
func (_m *DB) AddDocActorRelationship(ctx context.Context, collectionName string, docID string, relation string, targetActor string) (bool, error) {
...
func (_c *DB_AddDocActorRelationship_Call) Return(_a0 bool, _a1 error) *DB_AddDocActorRelationship_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DB_AddDocActorRelationship_Call) RunAndReturn(run func(context.Context, string, string, string, string) (bool, error)) *DB_AddDocActorRelationship_Call {
	_c.Call.Return(run)
	return _c
}
