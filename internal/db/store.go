...
func (db *DB) GetSchemaByVersionID(ctx context.Context, versionID string) (client.SchemaDescription, error) {
	...
	if err := db.checkNodeAccess(ctx, acpTypes.NodeSchemaGetByVersionPerm); err != nil {
...
func (db *DB) GetSchemas(
	...
	if err := db.checkNodeAccess(ctx, acpTypes.NodeSchemaGetPerm); err != nil {
		return nil, err
	}
...
func (db *DB) PatchSchema(
	...
	if err := db.checkNodeAccess(ctx, acpTypes.NodeSchemaPatchPerm); err != nil {
		return err
	}
