...
func performAction(
	...
	case ReEnableAdminACP:
		reEnableAdminACP(s, action)

	case DisableAdminACP:
		disableAdminACP(s, action)

	case AddActorRelationshipWithAAC:
		addActorRelationshipWithAAC(s, action)

	case DeleteActorRelationshipWithAAC:
		deleteActorRelationshipWithAAC(s, action)

	case GetAdminACPStatus:
		getAdminACPStatus(s, action)
